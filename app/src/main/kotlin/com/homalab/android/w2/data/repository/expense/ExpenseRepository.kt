...
class ExpenseRepository @Inject constructor(private val expenseDataSource: ExpenseDataSource) {
    ...
    suspend fun createExpense(expense: Expense): Long = expenseDataSource.createExpense(expense)

    suspend fun deleteExpense(expense: Expense): Int = expenseDataSource.deleteExpense(expense)

    suspend fun updateExpense(expense: Expense): Int = expenseDataSource.updateExpense(expense)
