...
val incomeCategories = listOf(
    Category(0, "Allowance", Category.Type.INCOME.ordinal, System.currentTimeMillis(), System.currentTimeMillis(), allowanceCategories),
    Category(0, "Salary", Category.Type.INCOME.ordinal,System.currentTimeMillis(), System.currentTimeMillis(), salarySubCategories),
    Category(0, "Petty cash", Category.Type.INCOME.ordinal,System.currentTimeMillis(), System.currentTimeMillis(), pettyCashSubCategoties),
    Category(0, "Bonus", Category.Type.INCOME.ordinal,System.currentTimeMillis(), System.currentTimeMillis(), bonusSubCategories),
    Category(0, "Other", Category.Type.INCOME.ordinal, System.currentTimeMillis(), System.currentTimeMillis(), otherSubCategories)
)